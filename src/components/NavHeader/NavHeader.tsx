  ...
  return (
    <nav className='container flex justify-between items-center mt-3'>
      ...
      <div>
        <Link
          to={path.home}
          className={`font-semibold mx-3 capitalize ${
            location.pathname === path.home ? 'text-blue hover:text-blue/70' : 'hover:text-black/70'
          }`}
        >
          Trang chủ
        </Link>
        <Link
          to={path.profile}
          className={`font-semibold mx-3 capitalize ${
            location.pathname === path.profile ? 'text-blue hover:text-blue/70' : 'hover:text-black/70'
          }`}
        >
          Về chúng tôi
        </Link>
        <Link
          to={path.policy}
          className={`font-semibold mx-3 capitalize ${
            location.pathname === path.policy ? 'text-blue hover:text-blue/70' : 'hover:text-black/70'
          }`}
        >
          Chính sách
        </Link>
        ...
        <Link
          to={path.contact}
          className={`font-semibold mx-3 capitalize ${
            location.pathname === path.contact ? 'text-blue hover:text-blue/70' : 'hover:text-black/70'
          }`}
        >
          Liên hệ
        </Link>
      ...
      <div className='flex items-center'>
        {/* <Popover
          className='flex cursor-pointer items-center py-1 hover:text-black/70 '
          renderPopover={
              ...
              renderPopover={
                <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                  <Link
                    ...
                    className='block w-full bg-white py-3 px-4 text-left hover:bg-slate-100 hover:text-[#1e6ddb]'
                  >
                    Đơn mua
                  </Link>
                  <Link
