...
export default function Profile() {
  ...
  return (
    <div className='container mx-auto pt-[150px]'>
      <div className='rounded-sm bg-white px-2 pb-10 shadow md:px-7 md:mb-20 '>
        ...
        <FormProvider {...methods}>
          <form className='mt-8 flex flex-col-reverse md:flex-row md:items-star' onSubmit={onSubmit}>
            <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
              ...
              />
              <div className='mt-2 flex flex-col flex-wrap flex-end sm:flex-row'>
                <div className='truncate pt-3 capitalize sm:w-[20%] sm:text-right' />
                <div className='sm:w-[80%] sm:pl-5 flex justify-end mt-3 pr-5'>
                  <Button
