...
export default function ChangePassword() {
  ...
  return (
    <div className='container mx-auto pt-[150px]'>
      <div className='rounded-sm bg-white px-2 pb-10 shadow md:px-7 md:pb-20 mb-24'>
        ...
        <form className='mt-8 mx-auto max-w-2xl' onSubmit={onSubmit}>
          <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
            <div className='mt-2 flex flex-col items-center sm:flex-row'>
              ...
              <div className='sm:w-[80%] sm:pl-6'>
                <Input
                  classNameInput='w-full px-3 py-3 rounded-lg border border-gray-300 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-6'
                  className='relative '
                  register={register}
                  name='password'
                  type='password'
            ...
            <div className='mt-2 flex flex-col items-center sm:flex-row'>
              <div className='truncate pt-3 capitalize sm:w-[25%] sm:text-right'>Nhập lại mật khẩu:</div>
              <div className='sm:w-[80%] sm:pl-6'>
                <Input
                  classNameInput='w-full px-3 py-3 rounded-lg border border-gray-300 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-6'
                  className='relative '
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              ...
              <div className='sm:w-[80%] sm:pl-5 flex justify-end mt-3'>
                <Button
                  className='flex h-9 items-center rounded-lg bg-blue px-5 text-center text-sm text-white hover:bg-blue/80'
                  type='submit'
                >
                  Lưu
                </Button>
